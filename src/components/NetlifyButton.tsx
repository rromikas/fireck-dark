...
const NetlifyButton: React.FC<NetlifyButtonProps> = () => {
  return (
    <div className="flex items-center whitespace-nowrap text-green-netlify hover:text-white hover:bg-green-netlify h-42px rounded-lg bg-white font-medium px-5 cursor-pointer">
